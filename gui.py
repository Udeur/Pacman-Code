#Module containing source code of the gui prototyp 2.0
...
#Events----------------------------------------------------------------------------------
    ...
    def clickStart(self):
        ...
        if self.intputsAreValid():
            ...
            elif agent=='DeepQAgent SE (TF)' or agent=='DeepQAgent EE (TF)':
                str1 = "TensorFlow Agents are using a special version of 'pacman.py'. \n" \
                "It cannot be integrated into the GUI for now!"
                tkMessageBox.showinfo("TensorFlow Agents are not available", str1)
                return
