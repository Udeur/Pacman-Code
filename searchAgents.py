...
class ClosestDotSearchAgent(SearchAgent):
    ...
    def registerInitialState(self, state):
        print "ClosestDotSearchAgent"
        self.actions = []
        currentState = state
        while(currentState.getFood().count() > 0):
            print "Aufruf - findPathToClosestDot"
    ...
    def findPathToClosestDot(self, gameState):
        ...
        # Fuer jeden ClostestDot wird search.bfs(problem) ausgefuehrt. Gibt eine Liste von Aktionen aus, mit deren Hilfe man zu dem ClostetDot kommt. Wichtig hierbei bfs!!
...
class AnyFoodSearchProblem(PositionSearchProblem):
    ...
    def isGoalState(self, state):
        ...
        # If there is food on the ground with coordinates [x][y], return true;
        # else return false;
        x,y = state
        # print "State", state
